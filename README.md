...
<td><kbd><a href="https://raw.githack.com/eurostat/d3.examples/master/example2/example2_icw_raw.html"><img src="docs/example2_icw.png" alt="Example 2 ICW" width="300"></a></kbd></td>
<td><kbd><a href="https://raw.githack.com/eurostat/d3.examples/master/example3/example3_toc_raw.html"><img src="docs/example3_toc.png" alt="Example 3 ToC" width="300"></a></kbd></td>
</tr>
</table>
...
Through, for instance, [`githack`](https://raw.githack.com/), a **preview of this webpage is made available at this [address](https://raw.githack.com/eurostat/d3.examples/master/example1//example1_peps01.html)**  (though the display is much slower and some of the page features are disabled).
...
A **preview of this webpage is made available at this [address](https://raw.githack.com/eurostat/d3.examples/master/example2/example2_icw_raw.html)** while another example based on the metadata for the **EU-SILC dataset is presented [here](https://raw.githack.com/eurostat/d3.examples/master/example2/example2_ilc_raw.html)**.
